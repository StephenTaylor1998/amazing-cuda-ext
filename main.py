...
from amz_cuda_ext.test_neurons.test_if_neuron import test_if_speed as test_if_speed_v1
from amz_cuda_ext.test_neurons.test_if_neuron_v2 import test_if_speed as test_if_speed_v2
